...
class Luke(Base_Connector):
    def __init__(self, args):
        ...
        roberta_path = '/data3/private/yedeming/bert_models/roberta-base'
        ...
        with torch.no_grad():
            ...
            if try_cuda:
                outputs = self.luke_model(
                    ...
                    attention_mask=attention_mask_list.cuda(),#.to(device=self.luke_model.device),
                    entity_ids=entity_ids_list.cuda(),#(entity_embeddings_list/L_entity).cuda() * 3.64537835,
                ...
                outputs = self.luke_model(
                    ...
                    attention_mask=attention_mask_list,#.to(device=self.luke_model.device),

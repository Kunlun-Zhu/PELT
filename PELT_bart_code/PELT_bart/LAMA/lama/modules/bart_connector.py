...
class Bart(Base_Connector):
    def __init__(self, args):
        ...
        self.luke_tokenizer = BartTokenizer.from_pretrained( '/data3/private/yedeming/bert_models/bart-base' )
        # self.luke_tokenizer = BartTokenizer.from_pretrained( '/data/private/yedeming/bert_models/bart-base' )

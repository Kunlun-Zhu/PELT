...
class ERNIE(Base_Connector):
    def __init__(self, args):
        ...
        # self.kind = args.kind
        print ('Loading KG')
        self.tokenizer = RobertaTokenizer.from_pretrained( '/data3/private/ydm_tmp/bert_models/roberta-base' )
        # config = RobertaConfig.from_pretrained(  '/data3/private/yedeming/bert_models/roberta-base' )
    ...
    def get_batch_generation(self, sentences_list, logger=None, try_cuda=True, sub_labels=None, sub_ids=None):
        ...
        for masked_inputs_list, sub_label, sub_id in zip(sentences_list, sub_labels, sub_ids):
            ...
            for idx, masked_input in enumerate(masked_inputs_list):
                ...
                if( sub_s>=0) and (sub_embid>=0):# or self.args.null_entmask): # need sub_embid?
